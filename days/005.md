...
## Key Takeaways
- There are a lot of random Medium articles and developer documents out there giving you differing advice on how to configure this. 
- Since the operating system is largely RHEL-based, it's probably best to go with official RHEL documentation for CentOS.
